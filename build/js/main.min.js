...
/* harmony import */ var _modules_dropdown_text__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/dropdown-text */ "./js/modules/dropdown-text.js");
/* harmony import */ var _modules_script_acc__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/script-acc */ "./js/modules/script-acc.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_dropdown_text__WEBPACK_IMPORTED_MODULE_2__["dropdownText"])();
    Object(_modules_mask__WEBPACK_IMPORTED_MODULE_4__["maskPhone"])();
    Object(_modules_script_acc__WEBPACK_IMPORTED_MODULE_3__["accordion"])();
  });
});
...
/***/ "./js/modules/dropdown-text.js":
/*!*************************************!*\
  !*** ./js/modules/dropdown-text.js ***!
  \*************************************/
/*! exports provided: dropdownText */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "dropdownText", function() { return dropdownText; });
var dropdownText = function dropdownText() {
  var btnDropdown = document.querySelector('[data-dropdown]');
  var infoContainer = document.querySelector('[data-dropdown-box]');
  if (btnDropdown) {
...
var maskPhone = function maskPhone() {
  var inputElement = document.querySelectorAll('input[type=tel]');
  var maskOptions = {
    mask: '+{7} (000) 000-00-00'
  };
  inputElement.forEach(function (item) {
    // eslint-disable-next-line
    Object(imask__WEBPACK_IMPORTED_MODULE_0__["default"])(item, maskOptions);
  });
};
...
var Accordions = function () {
  var closeOthers = function closeOthers(current, parent) {
    var opened = Array.from(parent.querySelectorAll('.accordion__sections[open]'));
  ...
  var toggle = function toggle(event, selector) {
...
var accordion = function accordion() {
  if (document.documentElement.clientWidth < 769) {
    var opened = Array.from(document.querySelectorAll('.accordion__sections[open]'));
    if (opened) {
    ...
    // eslint-disable-next-line
    var accordionSection = new Accordions('[data-accordion]');
  }
};
